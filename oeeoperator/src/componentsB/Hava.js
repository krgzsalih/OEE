...
const data = [
    {name: '4/24', tbf: 2,sinir:8},
    {name: '4/25', tbf: 4,sinir:8},
    {name: '4/26', tbf: 7,sinir:8},
    {name: '4/27', tbf: 1,sinir:8},
    {name: '4/28', tbf: 4,sinir:8},
    {name: '4/29', tbf: 3,sinir:8},
];
                    ...
                    <Grid container direction="row" xs={12} sm={12} spacing={2}>
                        ...
                        <Grid  justify="center" item xs={12} sm={7}>
                            <Paper style={{height:135}}>
                                <Typography>Bu Günkü Hava Kullanımı</Typography>
                            ...
                            <Paper style={{height:135, marginTop:10}} >
                                <Typography>Aylık Hava Kullanımı</Typography>
                                <div style={{textAlign:'center', lineHeight:'90px'}}>
                                    <div style={{fontSize:'30px'}}>
                                       442,432m3
                                    </div>
                        ...
                        <Grid  justify="center" item xs={12} sm={5}>
                            <Paper  style={{height:280}}>
                                ...
                                <div style={{textAlign:'center'}}>
                                    <GaugeChart needleColor={'#6C699C'} arcsLength={[0.5, 0.3, 0.2]} colors={['#5BE12C', '#F5CD19', '#EA4228']} formatTextValue={(value) => (value*10)+'m3'} id="gauge-chart1"    percent={0.41}    />
                                </div>                            
                            </Paper>
                        </Grid>
                    </Grid>
